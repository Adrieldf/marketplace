...
class ProdutoDAO{
	...
	public function inserir($produto){
		include("conexao.php");
		$sql = 'INSERT INTO produto (idProduto, nome, modelo, Segmento, Descrição, preco) VALUES (:idProduto, :nome, :modelo, :Segmento, :Descrição, :preco)';
		$consulta = $conexao->prepare($sql);
		...
		$consulta->bindValue(':Descrição',$produto->getDescrição()); 
	...
	public function atualizar($produto){
		include("conexao.php");
		$sql = 'UPDATE produto SET idProduto = :idProduto, nome = :nome, modelo = :modelo, Segmento = :Segmento, Descrição = :Descrição, preco = :preco WHERE idProduto = :idProduto';
		$consulta = $conexao->prepare($sql);
		$consulta->bindValue(':idProduto',$produto->getIdProduto()); 
